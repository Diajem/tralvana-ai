...
Orchestrates the six core Discovery Layer modules plus optional Event
Intelligence behind one
traveller-facing response for broad requests (Intent.PLAN_TRIP).

Trip Brain is an orchestration layer, not a domain Discovery module — it
